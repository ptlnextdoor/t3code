...
const STOPWORDS = new Set<string>([
  ...
  "with", "from", "up", "out", "off", "over", "into", "my", "your", "his", "her",
  "its", "our", "their", "i", "me", "we", "he", "she", "they", "it", "is", "are",
  "was", "were", "be", "been", "am", "do", "does", "did", "have", "has", "had",
  "will", "would", "should", "could", "can", "need", "needs", "get", "got",
  "that", "this", "these", "those", "so", "just", "still", "before", "after",
  "about", "than", "then", "now", "not", "no", "yes", "okay", "um", "uh", "like",
  "really", "actually", "maybe", "thing", "things", "some", "any", "all",
]);
